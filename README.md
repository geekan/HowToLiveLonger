...
* 研究仅表达相关：所有文献表明的更多是相关而非因果，在阅读时要考虑文献是否充分证明了因果 —— 如某文献表明了日均>=7000步的人有显著低的全因死亡率。但步数多的人一般没有长期重病，而长期重病步数一定会<7000。那么可以推导<7000步的人很有可能是非瞬间死亡，而>=7000步的人很有可能是瞬间死亡，如果没有合理的排除这块数据，那这个文献的调查就失真了

### 行动

* 输入
  * 固体：吃白肉（-3%\~-11% ACM）、蔬果为主（-17%\~-26% ACM），多吃辣（-23% ACM），多吃坚果（-4%\~-27% ACM），少吃蛋黄（或+7% ACM/颗/天），中量碳水（少或多都不好 BMJ：这么吃，心血管疾病和死亡风险更低 link）、多吃植物蛋白（-10% ACM）
  * 液体：喝咖啡（-12%\~-22% ACM），喝牛奶（-10%\~-17% ACM），喝茶（-8%\~15% ACM），少喝或不喝甜味饮料（或每天一杯+7% ACM，+多巴胺），戒酒或每周100g内（或+\~50% ACM，无上限）
  * 气体：不吸烟（或+~50% ACM，无上限）
  * 光照：晒太阳（-~40% ACM）
...
* 输出
  ...
  * 日常：刷牙（-25% ACM）
  * 睡眠：每天睡7小时全因死亡率最低（早睡+43% ACM，晚睡+15% ACM）
* 上下文
  * 体重：减肥（-54% ACM）
...
* 输入
  ...
  * 液体
    ...
    * 果汁
      * [JAMA子刊：100%纯果汁可能比含糖饮料更危险](JAMA子刊：100%纯果汁可能比含糖饮料更危险)
...
* 输出
  ...
  * 走路
    * [走路降低全因死亡率超过50%！每天走多少步最合适？《JAMA》子刊超10年研究告诉你答案](http://www.shcell.org/219/3571.html)</sup>
